...
class TextFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        mutilLabel = wx.StaticText(panel,-1,"mutil-line")
        mutilText = wx.TextCtrl(panel,-1,"here is a looooooong line\n\n"
                                         "See that it ",
                                         size=(200,100),style=wx.TE_MULTILINE)
        mutilText.SetInsertionPoint(0)

        richLabel = wx.StaticText(panel,-1,"Rich Text")
        richText = wx.TextCtrl(panel,-1,
                                "If supported by native control,this is reversed,and this is a different font,",
        ...
        sizer.AddMany([mutilLabel,mutilText,richLabel,richText])
